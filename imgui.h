...
namespace ImGui
{
    ...
    IMGUI_API void          SortWindows(std::vector<ImGuiWindow*>& windows);
    IMGUI_API void          ProgressiveRender(const std::vector<ImGuiWindow*>& windows, std::set<std::string>& renderered, bool final_draw);
...
enum ImGuiCol_
{
    ...
    ImGuiCol_WindowAsciiBorderL,
    ImGuiCol_WindowAsciiBorderT,
    ImGuiCol_WindowAsciiBorderR,
    ImGuiCol_WindowAsciiBorderB,
    ImGuiCol_WindowAsciiBorderTL,
    ImGuiCol_WindowAsciiBorderTR,
    ImGuiCol_WindowAsciiBorderBR,
    ImGuiCol_WindowAsciiBorderBL,
    ImGuiCol_TitleBarText,
    ImGuiCol_COUNT
};
...
struct ImGuiIO
{
    ...
    bool        KeysDown[9999];                  // Keyboard keys that are pressed (ideally left in the "native" order your engine has access to keyboard keys, so you can use your own defines/enums for keys).
    ...
    float       KeysDownDuration[9999];          // Duration the keyboard key has been down (0.0f == just pressed)
    float       KeysDownDurationPrev[9999];      // Previous duration the key has been down
